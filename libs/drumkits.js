...
const eoeKit = new Drumkit('808 Kit', [
  ...
  { url: '/audio/kit-808/conga-low.mp3', name: 'Conga L' },
  { url: '/audio/kit-808/conga-mid.mp3', name: 'Conga M' },
  { url: '/audio/kit-808/conga-high.mp3', name: 'Conga H' },
...
const acousticKit = new Drumkit('Acoustic Kit', [
  ...
  { url: '/audio/kit-acoustic/hihat-foot.mp3', name: 'HH Foot' },
  { url: '/audio/kit-acoustic/hihat-closed.mp3', name: 'HH Closed' },
  { url: '/audio/kit-acoustic/hihat-open.mp3', name: 'HH Open' },
