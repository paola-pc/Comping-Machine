                ...
                {userTracks?.map(track => (
                  <li key={track.id + '-li'} className="flex justify-between items-center h-fit rounded-lg text-sky-200 hover:text-white opacity-90 p-2 list-[square] hover:bg-fuchsia-950">
                    ...
                    <div id='userSessionList-controls' className="flex gap-3">
                      {/* <Link href={`/user/session/${track.id}`} className="mx-1 bg-gray-950 border border-emerald-600 rounded-xl text-emerald-300 p-2 cursor-pointer hover:text-white hover:bg-emerald-500 shadow shadow-sm shadow-emerald-400 hover:shadow-none">
                        OPEN
                      </Link> */}
